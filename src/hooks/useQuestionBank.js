...
export function flattenExams(examList) {
  return examList.flatMap((exam) =>
...
const ALL_QUESTIONS = flattenExams(EXAM_LIST);

export const DOMAINS = ["Cloud Concepts", "Security and Compliance", "Technology", "Billing and Pricing"];

export function filterAndSortQuestions(all, { search, filters, sort }) {
...
export function useQuestionBank() {
  ...
  const filteredList = useMemo(
    () => filterAndSortQuestions(ALL_QUESTIONS, { search, filters, sort }),
    [search, filters, sort]
  );
